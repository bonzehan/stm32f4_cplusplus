#ifndef __AP_HAL_STM32F4_H__
#define __AP_HAL_STM32F4_H__

/* Your layer exports should depend on AP_HAL.h ONLY. */
#include <AP_HAL.h>

/**
 * Umbrella header for AP_HAL_STM32F4 module.
 ...
 * names, headers) via the STM32F4 namespace.
 * The class implementing AP_HAL::HAL should be called HAL_STM32F4 and exist
 * in the global namespace. There should be a single const instance of the
 * HAL_STM32F4 class called AP_HAL_STM32F4, instantiated in the HAL_STM32F4_Class.cpp
 * and exported as `extern const HAL_STM32F4 AP_HAL_STM32F4;` in HAL_STM32F4_Class.h
 *
 * All declaration and compilation should be guarded by CONFIG_HAL_BOARD macros.
 * In this case, we're using CONFIG_HAL_BOARD == HAL_BOARD_STM32F4.
...
#include "AP_HAL_STM32F4_Main.h"

#endif // CONFIG_HAL_BOARD

#endif //__AP_HAL_STM32F4_H__
